                    ...
                    <div class="col-md-12">
                      <div class="card mb-2">
                        <div class="card-body">
                          ...
                          <p class="card-text text-center mb-1"><time datetime="{{ $value->date->format('Y-m-d')}}">{{ $value->date->format('d m Y')}}</time> | <time datetime="{{ $value->date->format('h:m')}}">{{ $value->date->format('h:m')}}</time></p>
